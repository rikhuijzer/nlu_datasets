from nlu_datasets.snips import get_folders, convert_data_spans, convert_data_message, convert_file_messages, read_snips2017
...
def test_convert_file_messages():
    file = nlu_datasets.utils.get_path(corpus) / intent / 'train_AddToPlaylist.json'
    ...
    assert expected == nlu_datasets.utils.convert_message_annotated(messages[4])
